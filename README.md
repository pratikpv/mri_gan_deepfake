...
1. MRI-GAN. 
    ...
    Model with tau = 0.3 and Generator with the lowest loss:    
      https://drive.google.com/file/d/1qEfI96SYOWCumzPdQlcZJZvtAW_OXUcH/view?usp=sharing
1. DeepFake detection models
    1. Plain-frames based:
        
        https://drive.google.com/file/d/1_Pxv6ptxqXKtDJNkodkDmMTD_KRo08za/view?usp=sharing
    1. MRI based: 
        
        https://drive.google.com/file/d/1xKzehNuq1B1th-_-U6OG9v2Q2Odws6VG/view?usp=sharing       

## DeepFake Detection App

Use the model to test a given video file.

1. Download all pre-trained model weights and save them at below mentioned paths
   1. MRI-GAN weights : assets/weights/MRI_GAN_weights.chkpt
   1. MRI-based DeepFake weights : deepfake_MRI_weights.chkpt
   1. plain-frames based DeepFake weights : assets/weights/deepfake_plain_frames_weights.chkpt
   
2. Run the command-line App        
    `python detect_deepfake_app.py --input_videofile <path to video file> --method <detection method>`
    
    detection method can be 'plain_frames' or 'MRI'
